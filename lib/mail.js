...
async function sendSMSMail(phoneNo, text) {
  log("sendSMSMail req:", phoneNo, text);
  const mailOptions = {
    from: `"Cat SMS" <${process.env.APP_SMTP_USERNAME}>`,
...
async function test() {
  ...
  //   });
  const mail = {
    to: "mcxiaoke@live.com",
    cc: "mcxiaoke@gmail.com, cido@qq.com",
    bcc: "mcxiaoke@icloud.com",
